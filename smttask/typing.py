...
from typing import (Optional, Type as TypingType, TypeVar, Generic,
...
class SeparateOutputs:
    ...
    # __origin__ = Iterable
    __args__: Tuple[TypingType[T]]

    # result_type: type
    item_type: TypingType[T]
...
def separate_outputs(item_type: TypingType[T], get_names: Callable[...,List[str]]):
    """
...
T = TypeVar('T')
class Type(TypingType[T], Generic[T]):
    """
