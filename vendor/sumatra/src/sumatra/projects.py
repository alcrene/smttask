...
from .versioncontrol import UncommittedModificationsError, get_working_copy, VersionControlError
from .core import TIMESTAMP_FORMAT
import mimetypes
import json
import logging
...
class Project(object):
    ...
    def __init__(self, name, default_executable=None, default_repository=None,
        ...
        self.sumatra_version = sumatra_version
